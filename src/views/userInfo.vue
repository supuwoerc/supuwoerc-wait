            ...
            <div class="title">
              ...
              <div>
                <i
                  ...
                  @click="editPersonInfo = true"
                  v-show="!editPersonInfo"
                  title="编辑"
                ></i>
                <i
              ...
              <div class="left">
                ...
                >
                  <el-image
                    ...
                    :src="$getServerSource(personInfo.avatar)"
                    fit="fill"
                  ></el-image>
                </el-upload>
              </div>
...
<script>
import { getCurrentUserInfo, logOut,uploadAvatar,updateMineInfo } from "../api/api";
export default {
  name: "userInfo",
  components: {
